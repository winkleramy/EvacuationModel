...
WASHOUT_TIME    = 16     # seconds crossing a washout
STOP_TIME       = 10     # seconds merging at stop sign or yield
GAP_TIME        = 5     # gap needed to merge in seconds
...
def test_mtbacheloma():
    ...
    communities = pd.DataFrame({
        ...
        "dwellings": [ 65, 20, 11, 18, 30./VEHICLES_PER_DWELLING ]
    })
...
def test_summit():
    ...
    links = pd.DataFrame([
        ...
        ["L7",  "N9",  "N10",   "SSJ Summit Woods",           0.9,        SPEED],
        ["L8",  "N10",  "N8",   "SSJ Miller Cutoff",           0.5,        SPEED],
